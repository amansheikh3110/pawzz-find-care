...
\keyline{Prototype:}{7 working, clickable screens (Home, Search, Provider Profile, Emergency SOS, Pet Health Timeline, AI Document Upload, AI Symptom Triage) --- \url{https://pawzz-find-care.vercel.app/} \textit{(placeholder --- final link added on deployment)}.}
...
\textbf{\color{inksoft}Tools \& AI platforms used:} Claude (Claude Code) for the working prototype, this document, and the extended web write-up. 
\newline
\quad
\textbf{\color{inksoft}Extended documentation:} \url{https://pawzz-find-care.vercel.app/} \textit{(placeholder --- final link added on deployment)}.
}
